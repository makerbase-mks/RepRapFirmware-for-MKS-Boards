...
static constexpr SDCardConfig SDCardConfigs[] = {
    ...
    {{0x6e39e1af}, SSP3, {PC_10, PC_11, PC_12, PC_9}}, // MSK_NANO_V3.0
};
...
void BoardConfig::Init() noexcept
{
    ...
    if(rslt == FR_OK)
    {
        ...
        SPI::getSSPDevice(SSP2)->initPins(PB_13, PC_2, PC_3, NoPin, DMA1_Stream3, DMA_CHANNEL_0, DMA1_Stream3_IRQn, DMA1_Stream4, DMA_CHANNEL_0, DMA1_Stream4_IRQn);
// FIXME
#if 0
